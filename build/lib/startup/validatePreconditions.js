...
const validatePreconditions = async ({ exitOnFailure = true } = {}) => {
    let success = true;
    success = (0, exports.checkIfRunningOnSupportedNodeVersion)(process_1.default.version) && success;
    success = (0, exports.checkIfRunningOnSupportedOS)(process_1.default.platform) && success;
    success = (0, exports.checkIfRunningOnSupportedCPU)(process_1.default.arch) && success;
    const asyncConditions = (await Promise.all([
        ...
        (0, exports.checkIfPortIsAvailable)(process_1.default.env.PORT ?? config_1.default.get('server.port')),
...
const checkIfRequiredFileExists = async (pathRelativeToProjectRoot) => {
    ...
    return await (0, promises_1.access)(path_1.default.resolve(pathRelativeToProjectRoot)).then(() => {
