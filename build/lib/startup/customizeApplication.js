...
const customizeChatbotAvatar = async () => {
    ...
    fs_1.default.copyFileSync('frontend/dist/frontend/assets/public/images/' + avatarImage, 'frontend/dist/frontend/assets/public/images/ChatbotAvatar.png');
};
const customizeHackingInstructorAvatar = async () => {
    ...
    fs_1.default.copyFileSync('frontend/dist/frontend/assets/public/images/' + avatarImage, 'frontend/dist/frontend/assets/public/images/hackingInstructor.png');
};
